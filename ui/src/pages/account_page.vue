        ...
        <section class="signup-form">
          <div class="input-field-wrapper">
            <div class="input-field">
              ...
              <span>
                <Field type="text" name="first-name" :rules="isValidString" id="first-name"
                  v-model="accountInfo.first_name" required />
            ...
            <div class="input-field">
              ...
              <span>
                <Field :rules="isValidString" type="text" name="last-name" id="last-name" v-model="accountInfo.last_name"
                  required />
            ...
            <div class="input-field">
              ...
              <input type="email" name="Work Email" id="work-email" v-model="accountInfo.work_email" required disabled />
            </div>
          </div>
          <div class="input-field-wrapper">
            <div class="input-field">
              ...
              <span style="gap: 0px">
                ...
                <span>
                  <Field type="text" name="employment-number" :rules="isValidNumber" id="employment-number"
                    v-model="accountInfo.employment_number" required />
            ...
            <div class="input-field">
              ...
              <span>
                <Field type="text" :rules="isValidString" name="mailing-address" id="mailing-address"
                  v-model="accountInfo.mailing_address" />
